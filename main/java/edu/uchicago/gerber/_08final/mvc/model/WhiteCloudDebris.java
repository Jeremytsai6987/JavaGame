...
public class WhiteCloudDebris extends Sprite{
    ...
    public WhiteCloudDebris(Sprite explodingSprite) {
        ...
        //rasterMap.put(0, loadGraphic("/imgs/exp/FireEffect/title000.png") );
        //rasterMap.put(1, loadGraphic("/imgs/exp/FireEffect/title001.png") );
        //rasterMap.put(2, loadGraphic("/imgs/exp/FireEffect/title002.png") );
        //rasterMap.put(3, loadGraphic("/imgs/exp/FireEffect/title003.png") );
        //rasterMap.put(4, loadGraphic("/imgs/exp/FireEffect/title004.png") );
        //rasterMap.put(5, loadGraphic("/imgs/exp/FireEffect/title005.png") );
        //rasterMap.put(6, loadGraphic("/imgs/exp/FireEffect/title006.png") );
        //rasterMap.put(7, loadGraphic("/imgs/exp/FireEffect/title007.png") );
        //rasterMap.put(8, loadGraphic("/imgs/exp/FireEffect/title008.png") );
        //rasterMap.put(9, loadGraphic("/imgs/exp/FireEffect/title009.png") );
        //rasterMap.put(10, loadGraphic("/imgs/exp/FireEffect/title010.png") );
        //rasterMap.put(11, loadGraphic("/imgs/exp/FireEffect/title011.png") );
        //rasterMap.put(12, loadGraphic("/imgs/exp/FireEffect/title012.png") );
        //rasterMap.put(13, loadGraphic("/imgs/exp/FireEffect/title013.png") );
        //rasterMap.put(14, loadGraphic("/imgs/exp/FireEffect/title014.png") );
